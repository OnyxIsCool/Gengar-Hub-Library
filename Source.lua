...
local redzlib = {
  Themes = {
    ...
    Fluxus = {
      ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(18, 28, 56)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 32, 64)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(16, 24, 48))
      }),
      ["Color Hub 2"] = Color3.fromRGB(22, 34, 70),
      ["Color Stroke"] = Color3.fromRGB(38, 60, 120),
      ["Color Theme"] = Color3.fromRGB(235, 240, 255),
      ["Color Text"] = Color3.fromRGB(245, 247, 255),
      ["Color Dark Text"] = Color3.fromRGB(170, 185, 220)
    },
    Green = {
      ["Color Hub 1"] = ColorSequence.new({
